...
public final class BungeeRIPalt extends Plugin {

	public static final String CHANNEL = "BungeeCord";
	public static final String SUBCHANNEL = "RIPalt";
	...
	public void info(String message) {
		getLogger().info("[RIPalt] " + message);
	}

	public void warn(String message) {
		getLogger().warning("[RIPalt] " + message);
	}

	public void debug(String message) {
		if (this.debug) getLogger().info("[RIPalt] " + message);
	}
